...
class LoginRequest extends FormRequest
{
   ...
   */
    protected function prepareForValidation()
    {
        ...
        FILTER_VALIDATE_EMAIL) ? 'email' : 'identifiant';
    ...
    public function rules()
    {
        return [
            'email' =>
                'required_without:identifiant|string|email|exists:users,email',
            'identifiant' =>
                'required_without:email|string|exists:users,identifiant',
